...
let voteChart = {
    ...
    class VoteChart extends Component {
        ...
        getData = async () => {
          return axios.get( urlServer + "/vote/get-web-result-hot-cold-nice")
          .then(res =>{     
      ...
      render() {
            return (
              <div className="chart-wrapper" style={{ height: '300px' }}>
                 <center><h4>All user's feedback</h4></center> 
                 <Doughnut data={voteChart} options={voteChartOpts} height={300} redraw/>
              </div>
                )}
      }
