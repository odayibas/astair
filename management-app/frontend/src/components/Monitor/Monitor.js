    ...
    return (
        <div>     
          ...
          <center><section style={ sectionStyle }>
            ...
            <Row>
              <Col className="text-dark  bg-transparent" style= {{paddingTop: '300px', border : this.state.border[2]}} onMouseEnter={this.mouseEnter(2)}  onMouseLeave={this.mouseLeave(2)} onClick={() => this.openModal3(2)}>                               
              </Col>
              <Col className="text-dark bg-transparent" style= {{paddingTop: '300px', border : this.state.border[3]}} onMouseEnter={this.mouseEnter(3)}  onMouseLeave={this.mouseLeave(3)} onClick={() => this.openModal4(3)}>
              </Col>
            </Row>
          </section> </center>
